...
public class Estrategia_Ordenacion_BandejaEntrada implements Estrategia_Ordenacion_Actividades{
	...
	public List<Actividad> ordenar() {
		...
		Actividad actPrueba1 = new Clase(1,asignaturaPruebaConActividades, "Prueba de ordnacion Bandeja", "Descripcion de prueba pendiente", LocalDateTime.now(), 0, 0, 0, true, false);
