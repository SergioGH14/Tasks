...
public class BorderPanePrincipalController  extends Application {
	private BorderPane root;
	
	@Override
	public void start(Stage primaryStage) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/view/BorderPanePrincipal.fxml"));
			...
			MenuLateralAsignaturasController pantallaInicialActiviades = loader.<MenuLateralAsignaturasController>getController();
